 ...
 * Author: ahmed radwan
 *
 * Created on September 11, 2022, 10:58 PM
 */
#include"mcal_i2c.h"
...
static void I2C_Interrupt_configuration(const mssp_i2c_t *i2c_obj)
{
       ...
       I2C_Interrupt_Disable();
        ...
        {
            I2C_Interrupt_High_priority_set();
        }
            else if(INTERRUPT_LOW_priority==_timer0->priority)
            {
                I2C_Interrupt_Low_priority_set();
            }
            else{/*no thing*/}
       ...
       I2C_BUS_COL_Disable();
        ...
        if(INTERRUPT_HIGH_priority==_timer0->priority)
        {
            I2C_BUS_COL_Interrupt_High_priority_set();
        }
        else if(INTERRUPT_LOW_priority==_timer0->priority)
        {
            I2C_BUS_COL_Interrupt_Low_priority_set();
        }
        else{/*no thing*/}
#else
