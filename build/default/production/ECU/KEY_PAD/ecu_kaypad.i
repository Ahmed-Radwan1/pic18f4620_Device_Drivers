...
# 12 "ECU/KEY_PAD/ecu_kaypad.h"
# 1 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h" 1
# 12 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h"
# 1 "ECU/KEY_PAD/../../MCAL/GPIO/../device_config.h" 1
# 11 "ECU/KEY_PAD/../../MCAL/GPIO/../device_config.h"
# 1 "ECU/KEY_PAD/../../MCAL/GPIO/../compiler.h" 1
# 12 "ECU/KEY_PAD/../../MCAL/GPIO/../compiler.h"
...
# 12 "ECU/KEY_PAD/../../MCAL/GPIO/../compiler.h" 2
# 11 "ECU/KEY_PAD/../../MCAL/GPIO/../device_config.h" 2
# 12 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECU/KEY_PAD/../../MCAL/GPIO/../mcal_std_types.h" 1
# 20 "ECU/KEY_PAD/../../MCAL/GPIO/../mcal_std_types.h"
...
# 13 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECU/KEY_PAD/../../MCAL/GPIO/../std_libraries.h" 1
# 11 "ECU/KEY_PAD/../../MCAL/GPIO/../std_libraries.h"
...
# 11 "ECU/KEY_PAD/../../MCAL/GPIO/../std_libraries.h" 2
...
# 13 "ECU/KEY_PAD/../../MCAL/GPIO/../std_libraries.h" 2

# 1 "ECU/KEY_PAD/../../MCAL/GPIO/../pic18f4620.h" 1
# 14 "ECU/KEY_PAD/../../MCAL/GPIO/../std_libraries.h" 2
# 14 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 15 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h" 2
# 42 "ECU/KEY_PAD/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW=0,
   GPIO_HIGH
}logic_t;
...
Std_returnType keypad_get_value(const keypad_t*_keypad,uint8* value)
{
    ...
    else
    {
       ...
       uint8 l_colums_counter=0;
       uint8 l_counter=0;
       logic_t l_colum_logic=0;
       for(l_rows_counter=0;l_rows_counter<4;l_rows_counter++)
       {
            for(l_counter=0;l_counter<4;l_counter++)
            {
                gpio_pin_write_logic(&(_keypad->keypad_rows_pins[l_counter]),GPIO_LOW);
            }
           gpio_pin_write_logic(&(_keypad->keypad_rows_pins[l_rows_counter]),GPIO_HIGH);
           for(l_colums_counter=0;l_colums_counter<4;l_colums_counter++)
           {
              gpio_pin_read_logic(&(_keypad->keypad_colums_pins[l_colums_counter]),&l_colum_logic);
              if(l_colum_logic==1)
              {
