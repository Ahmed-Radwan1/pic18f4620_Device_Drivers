...
# 1 "MCAL/USART/mcal_usart.h" 1
# 12 "MCAL/USART/mcal_usart.h"
# 1 "MCAL/USART/../std_libraries.h" 1
# 11 "MCAL/USART/../std_libraries.h"
...
# 11 "MCAL/USART/../std_libraries.h" 2
...
# 12 "MCAL/USART/../std_libraries.h" 2
...
# 12 "MCAL/USART/mcal_usart.h" 2

# 1 "MCAL/USART/../mcal_std_types.h" 1
# 20 "MCAL/USART/../mcal_std_types.h"
...
# 13 "MCAL/USART/mcal_usart.h" 2

# 1 "MCAL/USART/../GPIO/hal_gpio.h" 1
# 12 "MCAL/USART/../GPIO/hal_gpio.h"
# 1 "MCAL/USART/../GPIO/../device_config.h" 1
# 11 "MCAL/USART/../GPIO/../device_config.h"
# 1 "MCAL/USART/../compiler.h" 1
# 12 "MCAL/USART/../compiler.h"
...
# 12 "MCAL/USART/../compiler.h" 2
# 11 "MCAL/USART/../GPIO/../device_config.h" 2
# 12 "MCAL/USART/../GPIO/hal_gpio.h" 2



# 1 "MCAL/USART/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL/USART/../GPIO/hal_gpio.h" 2
# 42 "MCAL/USART/../GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW=0,
   GPIO_HIGH
}logic_t;
...
# 14 "MCAL/USART/mcal_usart.h" 2

# 1 "MCAL/USART/../INTERRUPT/mcal_internal_interrupt.h" 1
# 14 "MCAL/USART/../INTERRUPT/mcal_internal_interrupt.h"
# 1 "MCAL/USART/../INTERRUPT/mcal_interrupt_config.h" 1
# 14 "MCAL/USART/../INTERRUPT/mcal_interrupt_config.h"
# 1 "MCAL/USART/../INTERRUPT/mcal_interrupt_gen_cfg.h" 1
# 14 "MCAL/USART/../INTERRUPT/mcal_interrupt_config.h" 2
# 54 "MCAL/USART/../INTERRUPT/mcal_interrupt_config.h"
typedef enum{
   INTERRUPT_LOW_priority=0,
   INTERRUPT_HIGH_priority
}interrupt_priority_cfg;
# 14 "MCAL/USART/../INTERRUPT/mcal_internal_interrupt.h" 2
# 15 "MCAL/USART/mcal_usart.h" 2

# 1 "MCAL/USART/mcal_usart_cfg.h" 1
# 16 "MCAL/USART/mcal_usart.h" 2
# 63 "MCAL/USART/mcal_usart.h"
typedef enum{
...
static void EUSART_Baud_Rate_Calculation(const usart_t *_eusart)
{
    ...
    switch(_eusart->baudrate_gen_gonfig)
    {
        ...
        case BAUDRATE_ASYN_8BIT_lOW_SPEED:
            ...
            TXSTAbits.BRGH=0;
            BAUDCONbits.BRG16=0;
            Baudrate_temp= ((8000000/(float32)_eusart->baudrate)/64)-1;
            break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC=0;
            BAUDCONbits.BRG16=0;
            TXSTAbits.BRGH=1;
            Baudrate_temp= ((8000000/(float32)_eusart->baudrate)/16)-1;
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            BAUDCONbits.BRG16=1;
            TXSTAbits.BRGH=1;
            Baudrate_temp= ((8000000/(float32)_eusart->baudrate)/4)-1;
            break;
...
static void EUSART_ASYNC_TX_Init(const usart_t *_eusart)
{
    if(1==_eusart->usart_tx_cfg.usart_tx_enable)
    {
      ...
      else if(_eusart->usart_tx_cfg.usart_tx_9bit_enable==0)
      {
          TXSTAbits.TX9=0;
      }
      else{ }
...
# 276 "MCAL/USART/mcal_usart.c"
      ...
      else if(_eusart->usart_tx_cfg.usart_tx_interrupt_enable==0)
      {
          (PIE1bits.TXIE=0);
      }
      else{ }
...
# 320 "MCAL/USART/mcal_usart.c"
      ...
      else if(_eusart->usart_rx_cfg.usart_rx_interrupt_enable==0)
      {
          (PIE1bits.RCIE=0);
      }
      else{ }
      ...
      else if(_eusart->usart_rx_cfg.usart_rx_9bit_enable==0)
      {
          RCSTAbits.RX9=0;
      }
      else{ }
